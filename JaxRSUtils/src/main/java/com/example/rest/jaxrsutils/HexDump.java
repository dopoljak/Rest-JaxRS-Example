...
/**
 * HexDump class copied from
 * http://www.java2s.com/Code/Java/File-Input-Output/Hexdump.htm
 */
public class HexDump
{
	...
	return dump(src, srcIndex, length);
    }

    public static String dump(byte[] src, int index, int length)
    {
	if (length == 0) {
	    return null;
	}
